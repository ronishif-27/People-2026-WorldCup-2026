                ...
                return (
                  ...
                  >
                    ...
                    <div className="col-span-1 flex items-center gap-2 md:justify-center">
                      ...
                      {globalRank === 1 ? (
                        <div className="w-7 h-7 rounded-xl bg-amber-400 flex items-center justify-center text-white text-sm shadow-sm font-black border border-amber-300 animate-bounce">
                          🥇
                        </div>
                      ) : globalRank === 2 ? (
                    ...
                    <div className="col-span-5 flex items-center gap-3">
                      ...
                      <div className="truncate">
                        <span className="font-extrabold text-slate-800 flex items-center gap-1.5 text-sm">
                          {emp.fullName}
                          {isUser && (
                            <span className="bg-[#14665F] text-white text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-widest shadow-xs">
                              You
                            </span>
                          )}
                        </span>
                        ...
                        <div className="flex md:hidden items-center gap-2 mt-1 text-[10px] font-bold text-slate-500">
                          <span className="bg-slate-100 px-1.5 py-0.5 rounded text-[9px] uppercase tracking-wider text-[#14665F]">
                            {emp.department}
                          </span>
                          <span>•</span>
                    ...
                    {/* Department (Desktop) */}
                    <div className="hidden md:col-span-3 text-slate-600 font-bold text-xs uppercase tracking-wider">
                    ...
                    <div className="hidden md:col-span-2 text-slate-500 font-bold text-xs flex items-center gap-1 uppercase tracking-wider">
                      <MapPin className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                      {emp.site}
                    </div>

                    {/* Coins Balance Total */}
                    <div className="col-span-1 text-right flex md:block justify-between items-center bg-slate-50 md:bg-transparent px-3 py-2 md:p-0 rounded-xl mt-1 md:mt-0 border border-slate-100 md:border-transparent">
